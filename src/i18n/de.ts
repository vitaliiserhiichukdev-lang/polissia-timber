...
export const de: Dictionary = {
  ...
  hero: {
    ...
    scrollLabel: 'Zum Abschnitt Nachweise springen',
  ...
  gallery: {
    ...
    lead: 'Bretter nach Klasse, Kiefernquerschnitte auf dem Platz und zwölf Parkett-Farbtöne — aufgenommen auf unserem eigenen Platz und in unserer Werkstatt, nicht bei einer Bildagentur gekauft.',
    filterLabel: 'Galerie nach Kategorie filtern',
    filters: {
      all: 'Alle Fotos',
      oak: 'Eichenbretter',
      pine: 'Kiefernholz',
  ...
  exportSection: {
    ...
    // TO CONFIRM — indikative Länderliste
    markets: [
      'Polen',
      'Deutschland',
      'Tschechien',
